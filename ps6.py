    ...
    * The final score is displayed.
    ...
    while word != '.':
        if remainingTime<0:
            ...
            break
        print("You have ",remainingTime," sconds remaining")
        if not is_valid_word(word, hand, word_list):
            print("wrong input. Try again....")
        else:
            score = get_word_score(word, HAND_SIZE) / totalTimeTaken
            finalScore += score
            print(word,'  made  ',score,'  points. Your total score is:  ',finalScore)
